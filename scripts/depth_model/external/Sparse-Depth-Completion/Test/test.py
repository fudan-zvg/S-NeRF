...
parser.add_argument('--crop_w', type=int, default=1600, help='width of image after cropping')
parser.add_argument('--crop_h', type=int, default=800, help='height of image after cropping')
...
def main():
    ...
    with torch.no_grad():
        ...
        for i, (img, rgb) in tqdm.tqdm(enumerate(dataset)):
            ...
            assert raw_pil.size == (1600, 900)

            crop = 900-args.crop_h
            raw_pil_crop = raw_pil.crop((0, crop, 1600, 900))
            # gt_pil_crop = gt_pil.crop((0, crop, 1600, 900))
            ...
            if args.input_type == 'rgb':
                ...
                assert rgb_pil.size == (1600, 900)
                rgb_pil_crop = rgb_pil.crop((0, crop, 1600, 900))
            ...
            pil_img.save(os.path.join(save_root, "%010d.png" % i))
